...
class CollectionParameterBag implements \JsonSerializable
{
    /**
     * @var array
     */
    ...
    public static function createFromCollection(Collection $collection, UrlGeneratorInterface $generator, string $select_mode = CollectionTypeInterface::SELECT_MODE_NONE, $settings = [])
    {
        $bag = new CollectionParameterBag($settings);
        ...
        $urlParameter['collection'] = $collection->getIdentifier();
        $urlParameter['content_type'] = $collection->getContentType()->getIdentifier();
        ...
        if(count($collection->getContentType()->getLocales()) > 1) {
    ...
    public function isSelectModeSingle() : bool {
        return $this->selectMode == CollectionTypeInterface::SELECT_MODE_SINGLE;
    }
    ...
    public function isSelectModeNone() : bool {
        return $this->selectMode == CollectionTypeInterface::SELECT_MODE_NONE;
    }
